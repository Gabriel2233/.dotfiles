...
_G.packer_plugins = {
  ...
  ["express_line.nvim"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/express_line.nvim",
  ...
  ["gruvbuddy.nvim"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/gruvbuddy.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/vim-bbye",
  ...
  ["vim-gofmt"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/vim-gofmt",
    url = "https://github.com/darrikonn/vim-gofmt"
  },
  ["vim-vinegar"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/vim-vinegar",
